...
# uncomment code to output the map
...
## Plots for Report
# Uncomment the code to output the plots
...
remove(ozone_airport_ccf_list,ozone_airport_ccf,CCF_Ozone_Airport_Graph,
...
# Clean Environment
remove(CO2_Long_V1, Ozone_CO2_Combined_Long, Ozone_CO2_Combined_Long_Scaled)
```
...
# Clean Environment
remove(C, comp_df, computational_time_density_plot, eigen_pc,
       eigen_proj, kernlab_pc, kernlab_proj, kpca_kernlab_linear,
       nipals_pc, nipals_proj, prcomp_pc, prcomp_proj, 
       time_eigen_pca, time_kernlab_pca, time_nipals_pca,
       time_prcomp_pca, time_svd_pca, eigen_C_values, i, j,
       svd_singular_values, X_svd)
```
...
# Clean environment
remove(biplot_1_2_groups, biplot_1_2_groups_ellipses, biplot_1_2_plain,
       biplot_3_4_groups_ellipses)
```
...
# Clean Environment
remove(pca_regression, pca_scree, pcr_4_pc, pcr_all_pc,
       percent_variance_explained, prcomp_pca, svd_pc, 
       svd_proj, pca_regression_model, svd_eigenvalues, 
       model_pc_example, model_linear_1, df_example)
```
